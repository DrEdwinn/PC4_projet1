...
w0 = 2000;                          % angular frequency of mass-spring system % hammer/target mass ratio
MR = 10;                            % stiffness parameter for hammer
wH = 1000;                          % hammer stiffness nonlinearity exponent
alpha = 2;
...
u = 2*u1-u2-w0^2*k^2*u1+MR*k^2*f(n-1); out(n) = u;
u2 = u1; u1 = u;
uH2 = uH1; uH1 = uH;
end
